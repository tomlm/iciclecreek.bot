...
namespace Iciclecreek.Bot.Builder.Dialogs
{
    ...
    public class IcyDialog : Dialog
    {
        ...
        /// <summary>
        /// Default OnTurn handler for dialog maps activities to strongly typed methods, OnMessageActivityAsync(), OnTypingActivityAsync() etc.
        /// </summary>
        ...
        /// <summary>
        /// The default handler for MessageActivity 
        /// </summary>
        /// <remarks>
        /// The default implementation runs Recognizer against the message text and calls OnRecognizedIntentAsync 
        /// </remarks>
        ...
        /// <summary>
        /// Overload this method to handle unrecognized intents
        ...
        /// <summary>
        /// Invoked when an event activity is received from the connector
        /// </summary>
        /// <remarks>
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        protected virtual async Task<DialogTurnResult> OnMessageReactionActivityAsync(DialogContext dc, IMessageReactionActivity messageReactionActivity, CancellationToken cancellationToken)
        {
            return await dc.WaitForInputAsync();
        }
        ...
        protected virtual Task<DialogTurnResult> OnEventActivityAsync(DialogContext dc, IEventActivity eventActivity, CancellationToken cancellationToken)
        {
            ...
            return OnEventAsync(dc, eventActivity, cancellationToken);
        }
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        protected virtual Task<DialogTurnResult> OnEventAsync(DialogContext dc, IEventActivity eventActivity, CancellationToken cancellationToken)
        {
            return Task.FromResult(new DialogTurnResult(DialogTurnStatus.Waiting));
        }
        ...
        {
            switch (installationUpdateActivity.Action)
            {
                case "add":
                case "add-upgrade":
                    return OnInstallationUpdateAddAsync(dc, installationUpdateActivity, cancellationToken);
                case "remove":
                case "remove-upgrade":
                    return OnInstallationUpdateRemoveAsync(dc, installationUpdateActivity, cancellationToken);
            }
            return Task.FromResult(new DialogTurnResult(DialogTurnStatus.Waiting));
        }
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        protected virtual Task<DialogTurnResult> OnInstallationUpdateAddAsync(DialogContext dc, IInstallationUpdateActivity installationUpdateActivity, CancellationToken cancellationToken)
        {
            return Task.FromResult(new DialogTurnResult(DialogTurnStatus.Waiting));
        }
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        protected virtual Task<DialogTurnResult> OnInstallationUpdateRemoveAsync(DialogContext dc, IInstallationUpdateActivity installationUpdateActivity, CancellationToken cancellationToken)
        {
            return Task.FromResult(new DialogTurnResult(DialogTurnStatus.Waiting));
        }
