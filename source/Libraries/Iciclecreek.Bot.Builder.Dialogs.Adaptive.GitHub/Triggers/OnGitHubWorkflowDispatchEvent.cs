...
namespace Iciclecreek.Bot.Builder.Dialogs.Adaptive.GitHub.Triggers
{
	...
	public class OnGitHubWorkflowDispatchEvent : OnGitHubEvent
	{
		...
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubWorkflowDispatchEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubWorkflowDispatchEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubWorkflowDispatchEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
