...
{
    /// <summary>
    /// Trigger on github 'commit_comment' webhook event.
    /// </summary>
	public class OnGitHubCommitCommentEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubCommitCommentEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubCommitCommentEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubCommitCommentEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
