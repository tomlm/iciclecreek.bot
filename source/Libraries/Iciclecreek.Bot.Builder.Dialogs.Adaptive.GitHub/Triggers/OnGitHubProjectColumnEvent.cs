...
{
    /// <summary>
    /// Trigger on github 'project_column' webhook event.
    /// </summary>
	public class OnGitHubProjectColumnEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubProjectColumnEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubProjectColumnEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubProjectColumnEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.project_column)"),
