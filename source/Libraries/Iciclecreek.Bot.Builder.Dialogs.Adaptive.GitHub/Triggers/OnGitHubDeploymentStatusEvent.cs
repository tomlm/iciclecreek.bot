...
{
    /// <summary>
    /// Trigger on github 'deployment_status' webhook event.
    /// </summary>
	public class OnGitHubDeploymentStatusEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubDeploymentStatusEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubDeploymentStatusEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubDeploymentStatusEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.deployment)"),
                Expression.Parse("exists(turn.activity.value.deployment_status)"),
