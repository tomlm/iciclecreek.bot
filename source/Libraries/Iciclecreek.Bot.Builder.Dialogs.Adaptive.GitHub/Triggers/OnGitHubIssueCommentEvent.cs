...
{
    /// <summary>
    /// Trigger on github 'issue_comment' webhook event.
    /// </summary>
	public class OnGitHubIssueCommentEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubIssueCommentEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubIssueCommentEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubIssueCommentEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
