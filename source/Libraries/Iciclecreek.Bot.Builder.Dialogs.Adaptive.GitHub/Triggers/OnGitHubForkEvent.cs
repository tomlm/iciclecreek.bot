...
{
    /// <summary>
    /// Trigger on github 'fork' webhook event.
    /// </summary>
	public class OnGitHubForkEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubForkEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubForkEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubForkEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                Expression.Parse("exists(turn.activity.value.forkee)"),
