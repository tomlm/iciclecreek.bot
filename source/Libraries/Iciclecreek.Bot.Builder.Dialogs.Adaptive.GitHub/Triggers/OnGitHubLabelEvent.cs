...
{
    /// <summary>
    /// Trigger on github 'label' webhook event.
    /// </summary>
	public class OnGitHubLabelEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubLabelEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubLabelEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubLabelEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.label)"),
