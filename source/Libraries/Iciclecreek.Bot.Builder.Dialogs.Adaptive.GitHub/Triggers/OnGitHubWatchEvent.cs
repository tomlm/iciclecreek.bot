...
{
    /// <summary>
    /// Trigger on github 'watch' webhook event.
    /// </summary>
	public class OnGitHubWatchEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubWatchEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubWatchEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubWatchEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            actionCondition = Expression.Parse("turn.activity.value.action == 'started'");
