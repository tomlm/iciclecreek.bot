...
{
    /// <summary>
    /// Trigger on github 'milestone' webhook event.
    /// </summary>
	public class OnGitHubMilestoneEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubMilestoneEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubMilestoneEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubMilestoneEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.milestone)"),
