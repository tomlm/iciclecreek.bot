...
{
    /// <summary>
    /// Trigger on github 'deployment' webhook event.
    /// </summary>
	public class OnGitHubDeploymentEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubDeploymentEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubDeploymentEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubDeploymentEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
