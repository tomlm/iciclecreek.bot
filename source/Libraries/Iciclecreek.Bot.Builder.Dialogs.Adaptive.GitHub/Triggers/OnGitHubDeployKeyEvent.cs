...
{
    /// <summary>
    /// Trigger on github 'deploy_key' webhook event.
    /// </summary>
	public class OnGitHubDeployKeyEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubDeployKeyEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubDeployKeyEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubDeployKeyEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.key)"),
