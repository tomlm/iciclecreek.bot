...
{
    /// <summary>
    /// Trigger on github 'create' webhook event.
    /// </summary>
	public class OnGitHubCreateEvent : OnGitHubEvent
    {
        ...
        [JsonConstructor]
        public OnGitHubCreateEvent(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
