...
{
    /// <summary>
    /// Trigger on github 'pull_request_review_comment' webhook event.
    /// </summary>
	public class OnGitHubPullRequestReviewCommentEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubPullRequestReviewCommentEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubPullRequestReviewCommentEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubPullRequestReviewCommentEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.comment)"),
