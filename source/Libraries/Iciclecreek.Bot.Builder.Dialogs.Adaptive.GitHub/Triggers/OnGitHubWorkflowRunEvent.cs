...
{
    /// <summary>
    /// Trigger on github 'workflow_run' webhook event.
    /// </summary>
	public class OnGitHubWorkflowRunEvent: OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubWorkflowRunEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubWorkflowRunEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubWorkflowRunEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            else
            {
                actionCondition = Expression.OrExpression(
                    Expression.Parse("turn.activity.value.action == 'action'"),
