...
{
    /// <summary>
    /// Trigger on github 'package' webhook event.
    /// </summary>
	public class OnGitHubPackageEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubPackageEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubPackageEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubPackageEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.package)"),
