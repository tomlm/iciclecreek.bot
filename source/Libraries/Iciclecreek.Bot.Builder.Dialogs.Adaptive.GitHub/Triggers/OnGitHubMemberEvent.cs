...
{
    /// <summary>
    /// Trigger on github 'member' webhook event.
    /// </summary>
	public class OnGitHubMemberEvent: OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubMemberEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubMemberEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubMemberEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
