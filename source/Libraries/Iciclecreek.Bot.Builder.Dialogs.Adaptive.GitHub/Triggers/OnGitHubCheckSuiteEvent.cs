...
{
    /// <summary>
    /// Trigger on github 'check_suite' webhook event.
    /// </summary>
	public class OnGitHubCheckSuiteEvent : OnGitHubEvent
	{
		/// <summary>
		/// Class identifier.
		/// </summary>
		[JsonProperty("$kind")]
		public new const string Kind = "Iciclecreek.OnGitHubCheckSuiteEvent";

		/// <summary>
		/// Initializes a new instance of the <see cref="OnGitHubCheckSuiteEvent"/> class.
		/// </summary>
		...
		[JsonConstructor]
		public OnGitHubCheckSuiteEvent(string action=null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
		...
		public override Expression GetExpression()
		{
            ...
            else
            {
                actionCondition = Expression.OrExpression(
                    ...
                    Expression.Parse("turn.activity.value.action == 'requested'"),
            ...
            var propertyCondition = Expression.AndExpression(
                ...
                Expression.Parse("exists(turn.activity.value.check_suite)"),
