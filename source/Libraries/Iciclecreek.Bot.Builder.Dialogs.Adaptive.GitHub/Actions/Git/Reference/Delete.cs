...
{
    /// <summary>
    /// Action to call GitHubClient.Git.Reference.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Git.Reference.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && Reference != null)
            {
                ...
                return gitHubClient.Git.Reference.Delete(ownerValue, nameValue, referenceValue);
            }
            if (RepositoryId != null && Reference != null)
            {
                var repositoryIdValue = RepositoryId.GetValue(dc);
                var referenceValue = Reference.GetValue(dc);
                return gitHubClient.Git.Reference.Delete((Int64)repositoryIdValue, referenceValue);
            }

            throw new ArgumentNullException("Required [reference] arguments missing for GitHubClient.Git.Reference.Delete");
        }
    }
}
