...
{
    /// <summary>
    /// Action to call GitHubClient.Activity.Starring.GetAllStargazers() API.
    /// </summary>
    public class GetAllStargazers : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        ...
        public GetAllStargazers([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [] arguments missing for GitHubClient.Activity.Starring.GetAllStargazers");
        }
    }
}
