...
{
    /// <summary>
    /// Action to call GitHubClient.Activity.Events.GetAllForRepositoryNetwork() API.
    /// </summary>
    public class GetAllForRepositoryNetwork : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Activity.Events.GetAllForRepositoryNetwork";

        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllForRepositoryNetwork"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public GetAllForRepositoryNetwork([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
