...
{
    /// <summary>
    /// Action to call GitHubClient.Activity.Events.GetAll() API.
    /// </summary>
    public class GetAll : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHub.Activity.Events.GetAll";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Options != null)
            {
                ...
                return await gitHubClient.Activity.Events.GetAll(optionsValue).ConfigureAwait(false);
            }
            else
            return await gitHubClient.Activity.Events.GetAll().ConfigureAwait(false);
        }
    }
}
