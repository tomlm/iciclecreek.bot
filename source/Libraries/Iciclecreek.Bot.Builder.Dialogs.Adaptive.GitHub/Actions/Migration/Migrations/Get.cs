...
{
    /// <summary>
    /// Action to call GitHubClient.Migration.Migrations.Get() API.
    /// </summary>
    public class Get : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Migration.Migrations.Get";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Org != null && Id != null)
            {
                ...
                return await gitHubClient.Migration.Migrations.Get(orgValue, (Int32)idValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [org,id] arguments missing for GitHubClient.Migration.Migrations.Get");
        }
    }
}
