...
{
    /// <summary>
    /// Action to call GitHubClient.Migration.Migrations.GetAll() API.
    /// </summary>
    public class GetAll : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Migration.Migrations.GetAll";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Org != null && Options != null)
            {
                ...
                return await gitHubClient.Migration.Migrations.GetAll(orgValue, optionsValue).ConfigureAwait(false);
            }
            if (Org != null)
            {
                var orgValue = Org.GetValue(dc);
                return await gitHubClient.Migration.Migrations.GetAll(orgValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [org] arguments missing for GitHubClient.Migration.Migrations.GetAll");
        }
    }
}
