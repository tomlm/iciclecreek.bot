...
{
    /// <summary>
    /// Action to call GitHubClient.PullRequest.Review.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.PullRequest.Review.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && Number != null && ReviewId != null)
            {
                ...
                return gitHubClient.PullRequest.Review.Delete(ownerValue, nameValue, (Int32)numberValue, (Int64)reviewIdValue);
            }
            if (RepositoryId != null && Number != null && ReviewId != null)
            {
                ...
                var numberValue = Number.GetValue(dc);
                var reviewIdValue = ReviewId.GetValue(dc);
                return gitHubClient.PullRequest.Review.Delete((Int64)repositoryIdValue, (Int32)numberValue, (Int64)reviewIdValue);
            }

            throw new ArgumentNullException("Required [number,reviewId] arguments missing for GitHubClient.PullRequest.Review.Delete");
        }
    }
}
