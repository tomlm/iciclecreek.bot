...
{
    /// <summary>
    /// Action to call GitHubClient.PullRequest.Merge() API.
    /// </summary>
    public class Merge : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.PullRequest.Merge";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && Number != null && MergePullRequest != null)
            {
                ...
                return await gitHubClient.PullRequest.Merge(ownerValue, nameValue, (Int32)numberValue, mergePullRequestValue).ConfigureAwait(false);
            }
            if (RepositoryId != null && Number != null && MergePullRequest != null)
            {
                ...
                var numberValue = Number.GetValue(dc);
                var mergePullRequestValue = MergePullRequest.GetValue(dc);
                return await gitHubClient.PullRequest.Merge((Int64)repositoryIdValue, (Int32)numberValue, mergePullRequestValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [number,mergePullRequest] arguments missing for GitHubClient.PullRequest.Merge");
        }
    }
}
