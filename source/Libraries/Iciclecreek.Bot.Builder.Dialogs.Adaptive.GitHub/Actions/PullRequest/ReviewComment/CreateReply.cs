...
{
    /// <summary>
    /// Action to call GitHubClient.PullRequest.ReviewComment.CreateReply() API.
    /// </summary>
    public class CreateReply : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.PullRequest.ReviewComment.CreateReply";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && Number != null && Comment != null)
            {
                ...
                return await gitHubClient.PullRequest.ReviewComment.CreateReply(ownerValue, nameValue, (Int32)numberValue, commentValue).ConfigureAwait(false);
            }
            if (RepositoryId != null && Number != null && Comment != null)
            {
                ...
                var numberValue = Number.GetValue(dc);
                var commentValue = Comment.GetValue(dc);
                return await gitHubClient.PullRequest.ReviewComment.CreateReply((Int64)repositoryIdValue, (Int32)numberValue, commentValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [number,comment] arguments missing for GitHubClient.PullRequest.ReviewComment.CreateReply");
        }
    }
}
