...
{
    /// <summary>
    /// Action to call GitHubClient.PullRequest.ReviewRequest.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.PullRequest.ReviewRequest.Create";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [number,users] arguments missing for GitHubClient.PullRequest.ReviewRequest.Create");
        }
    }
}
