...
{
    /// <summary>
    /// Action to call GitHubClient.Issue.Comment.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Issue.Comment.Create";
        ...
        /// <summary>
        /// (REQUIRED) Gets or sets the expression for api argument newComment.
        /// </summary>
        /// <value>
        /// The value or expression to bind to the value for the argument.
        /// </value>
        ...
        public StringExpression NewComment  { get; set; }
