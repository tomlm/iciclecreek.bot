...
{
    /// <summary>
    /// Action to call GitHubClient.Issue.GetAllForOrganization() API.
    /// </summary>
    public class GetAllForOrganization : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Issue.GetAllForOrganization";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [organization] arguments missing for GitHubClient.Issue.GetAllForOrganization");
        }
    }
}
