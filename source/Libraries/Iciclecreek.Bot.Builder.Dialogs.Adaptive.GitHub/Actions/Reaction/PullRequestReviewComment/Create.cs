...
{
    /// <summary>
    /// Action to call GitHubClient.Reaction.PullRequestReviewComment.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Reaction.PullRequestReviewComment.Create";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [number,reaction] arguments missing for GitHubClient.Reaction.PullRequestReviewComment.Create");
        }
    }
}
