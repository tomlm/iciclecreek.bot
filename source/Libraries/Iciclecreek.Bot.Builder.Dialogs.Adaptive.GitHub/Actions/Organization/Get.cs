...
{
    /// <summary>
    /// Action to call GitHubClient.Organization.Get() API.
    /// </summary>
    public class Get : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Organization.Get";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [org] arguments missing for GitHubClient.Organization.Get");
        }
    }
}
