...
{
    /// <summary>
    /// Action to call GitHubClient.Organization.OutsideCollaborator.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Organization.OutsideCollaborator.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Org != null && User != null)
            {
                ...
                return await gitHubClient.Organization.OutsideCollaborator.Delete(orgValue, userValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [org,user] arguments missing for GitHubClient.Organization.OutsideCollaborator.Delete");
        }
    }
}
