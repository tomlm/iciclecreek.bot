...
{
    /// <summary>
    /// Action to call GitHubClient.Gist.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Gist.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Id != null)
            {
                ...
                return gitHubClient.Gist.Delete(idValue);
            }

            throw new ArgumentNullException("Required [id] arguments missing for GitHubClient.Gist.Delete");
        }
    }
}
