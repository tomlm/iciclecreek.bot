...
{
    /// <summary>
    /// Action to call GitHubClient.Gist.GetAllStarred() API.
    /// </summary>
    public class GetAllStarred : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        ...
        public GetAllStarred([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
