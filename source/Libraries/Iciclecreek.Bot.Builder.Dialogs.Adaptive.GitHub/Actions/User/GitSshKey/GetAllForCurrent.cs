...
{
    /// <summary>
    /// Action to call GitHubClient.User.GitSshKey.GetAllForCurrent() API.
    /// </summary>
    public class GetAllForCurrent : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.User.GitSshKey.GetAllForCurrent";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Options != null)
            {
                ...
                return await gitHubClient.User.GitSshKey.GetAllForCurrent(optionsValue).ConfigureAwait(false);
            }
            else
            return await gitHubClient.User.GitSshKey.GetAllForCurrent().ConfigureAwait(false);
        }
    }
}
