...
{
    /// <summary>
    /// Action to call GitHubClient.User.GpgKey.Get() API.
    /// </summary>
    public class Get : GitHubAction
    {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Id != null)
            {
                ...
                return await gitHubClient.User.GpgKey.Get((Int32)idValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [id] arguments missing for GitHubClient.User.GpgKey.Get");
        }
    }
}
