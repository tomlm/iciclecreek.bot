...
{
    /// <summary>
    /// Action to call GitHubClient.User.Administration.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.User.Administration.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Login != null)
            {
                ...
                return gitHubClient.User.Administration.Delete(loginValue);
            }

            throw new ArgumentNullException("Required [login] arguments missing for GitHubClient.User.Administration.Delete");
        }
    }
}
