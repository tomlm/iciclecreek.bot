...
{
    /// <summary>
    /// Action to call GitHubClient.User.Followers.GetAllFollowing() API.
    /// </summary>
    public class GetAllFollowing : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.User.Followers.GetAllFollowing";

        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllFollowing"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public GetAllFollowing([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [login] arguments missing for GitHubClient.User.Followers.GetAllFollowing");
        }
    }
}
