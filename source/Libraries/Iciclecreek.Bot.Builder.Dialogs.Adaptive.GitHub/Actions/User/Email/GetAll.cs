...
{
    /// <summary>
    /// Action to call GitHubClient.User.Email.GetAll() API.
    /// </summary>
    public class GetAll : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.User.Email.GetAll";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await gitHubClient.User.Email.GetAll().ConfigureAwait(false);
        }
    }
}
