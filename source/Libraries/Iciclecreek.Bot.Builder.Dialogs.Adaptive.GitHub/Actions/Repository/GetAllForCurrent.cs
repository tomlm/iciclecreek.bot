...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.GetAllForCurrent() API.
    /// </summary>
    public class GetAllForCurrent : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.GetAllForCurrent";
        ...
        public ObjectExpression<Octokit.RepositoryRequest> Request  { get; set; }
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await gitHubClient.Repository.GetAllForCurrent().ConfigureAwait(false);
        }
    }
}
