...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Comment.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Comment.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && Number != null)
            {
                ...
                return gitHubClient.Repository.Comment.Delete(ownerValue, nameValue, (Int32)numberValue);
            }
            if (RepositoryId != null && Number != null)
            {
                var repositoryIdValue = RepositoryId.GetValue(dc);
                var numberValue = Number.GetValue(dc);
                return gitHubClient.Repository.Comment.Delete((Int64)repositoryIdValue, (Int32)numberValue);
            }

            throw new ArgumentNullException("Required [number] arguments missing for GitHubClient.Repository.Comment.Delete");
        }
    }
}
