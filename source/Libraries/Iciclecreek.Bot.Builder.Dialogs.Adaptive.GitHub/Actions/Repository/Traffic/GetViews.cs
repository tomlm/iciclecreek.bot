...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Traffic.GetViews() API.
    /// </summary>
    public class GetViews : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Traffic.GetViews";

        /// <summary>
        /// Initializes a new instance of the <see cref="GetViews"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public GetViews([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [per] arguments missing for GitHubClient.Repository.Traffic.GetViews");
        }
    }
}
