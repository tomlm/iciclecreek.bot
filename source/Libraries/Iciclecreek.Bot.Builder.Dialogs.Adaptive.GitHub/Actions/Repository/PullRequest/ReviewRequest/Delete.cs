...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.PullRequest.ReviewRequest.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.PullRequest.ReviewRequest.Delete";
