...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.DeployKeys.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// <summary>
        /// (REQUIRED) Gets or sets the expression for api argument newDeployKey.
        /// </summary>
        /// <value>
        /// The value or expression to bind to the value for the argument.
        /// </value>
        [Required()]
        [JsonProperty("newDeployKey")]
        public ObjectExpression<Octokit.NewDeployKey> NewDeployKey  { get; set; }
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Owner != null && Name != null && NewDeployKey != null)
            {
                ...
                var newDeployKeyValue = NewDeployKey.GetValue(dc);
