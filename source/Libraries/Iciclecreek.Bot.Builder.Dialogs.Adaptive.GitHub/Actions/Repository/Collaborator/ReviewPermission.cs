...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Collaborator.ReviewPermission() API.
    /// </summary>
    public class ReviewPermission : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Collaborator.ReviewPermission";

        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewPermission"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public ReviewPermission([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [user] arguments missing for GitHubClient.Repository.Collaborator.ReviewPermission");
        }
    }
}
