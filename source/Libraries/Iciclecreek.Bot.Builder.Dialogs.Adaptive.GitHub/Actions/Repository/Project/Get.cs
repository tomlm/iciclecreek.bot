...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Project.Get() API.
    /// </summary>
    public class Get : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Project.Get";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [id] arguments missing for GitHubClient.Repository.Project.Get");
        }
    }
}
