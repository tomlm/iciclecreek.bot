...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Project.Delete() API.
    /// </summary>
    public class Delete : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Project.Delete";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Id != null)
            {
                ...
                return await gitHubClient.Repository.Project.Delete((Int32)idValue).ConfigureAwait(false);
            }

            throw new ArgumentNullException("Required [id] arguments missing for GitHubClient.Repository.Project.Delete");
        }
    }
}
