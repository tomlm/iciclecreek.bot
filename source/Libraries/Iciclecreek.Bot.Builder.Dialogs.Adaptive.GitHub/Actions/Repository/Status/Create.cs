...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Status.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Status.Create";
        ...
        /// <summary>
        /// (REQUIRED) Gets or sets the expression for api argument newCommitStatus.
        /// </summary>
        /// <value>
        /// The value or expression to bind to the value for the argument.
        /// </value>
        [Required()]
        [JsonProperty("newCommitStatus")]
        public ObjectExpression<Octokit.NewCommitStatus> NewCommitStatus  { get; set; }
