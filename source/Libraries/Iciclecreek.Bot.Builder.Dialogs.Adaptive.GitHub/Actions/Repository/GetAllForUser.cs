...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.GetAllForUser() API.
    /// </summary>
    public class GetAllForUser : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.GetAllForUser";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [login] arguments missing for GitHubClient.Repository.GetAllForUser");
        }
    }
}
