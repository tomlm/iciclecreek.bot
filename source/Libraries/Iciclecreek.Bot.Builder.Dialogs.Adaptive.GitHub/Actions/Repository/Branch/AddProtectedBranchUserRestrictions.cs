...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Branch.AddProtectedBranchUserRestrictions() API.
    /// </summary>
    public class AddProtectedBranchUserRestrictions : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Branch.AddProtectedBranchUserRestrictions";

        /// <summary>
        /// Initializes a new instance of the <see cref="AddProtectedBranchUserRestrictions"/> class.
        /// </summary>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public AddProtectedBranchUserRestrictions([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [branch,users] arguments missing for GitHubClient.Repository.Branch.AddProtectedBranchUserRestrictions");
        }
    }
}
