...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Invitation.GetAllForRepository() API.
    /// </summary>
    public class GetAllForRepository : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Invitation.GetAllForRepository";
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [repositoryId] arguments missing for GitHubClient.Repository.Invitation.GetAllForRepository");
        }
    }
}
