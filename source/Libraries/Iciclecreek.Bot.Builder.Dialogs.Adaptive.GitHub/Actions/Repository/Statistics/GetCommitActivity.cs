...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Statistics.GetCommitActivity() API.
    /// </summary>
    public class GetCommitActivity : GitHubAction
    {
        /// <summary>
        /// Class identifier.
        /// </summary>
        ...
        public GetCommitActivity([CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [] arguments missing for GitHubClient.Repository.Statistics.GetCommitActivity");
        }
    }
}
