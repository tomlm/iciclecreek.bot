...
{
    /// <summary>
    /// Action to call GitHubClient.Repository.Forks.Create() API.
    /// </summary>
    public class Create : GitHubAction
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "GitHubClient.Repository.Forks.Create";
        ...
        /// <summary>
        /// (REQUIRED) Gets or sets the expression for api argument fork.
        /// </summary>
        /// <value>
        /// The value or expression to bind to the value for the argument.
        /// </value>
        [Required()]
        [JsonProperty("fork")]
        public ObjectExpression<Octokit.NewRepositoryFork> Fork  { get; set; }
        ...
        protected override async Task<object> CallGitHubApi(DialogContext dc, Octokit.GitHubClient gitHubClient, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            throw new ArgumentNullException("Required [fork] arguments missing for GitHubClient.Repository.Forks.Create");
        }
    }
}
