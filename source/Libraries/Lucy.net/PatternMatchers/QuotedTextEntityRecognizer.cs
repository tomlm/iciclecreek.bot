...
namespace Lucy
{
    ...
    /// </summary>
    public class QuotedTextEntityRecognizer
    {
        /// <summary>
        ...
        public List<LucyEntity> Recognize(string text, string culture)
        {
        ...
        private class LanguageQuotePolicy
        {
            ...
            {
                var results = new List<LucyEntity>();
        ...
        private class QuotePattern
        {
            ...
            public IEnumerable<LucyEntity> Matches(string text)
            {
                List<LucyEntity> matches = new List<LucyEntity>();
                ...
                for (int index = 0; index < text.Length; index++)
                {
                    ...
                    else
                    {
                        if (ch == Postfix)
                        {
                            matches.Add(new LucyEntity()
                            {
                                Type = QuotedTextEntityRecognizer.QuotedText,
                                Start = quoteStart,
                                End = index,
                                Resolution = sb.ToString(),
                                Text = text.Substring(quoteStart, index - quoteStart),
                            });
                            sb.Clear();
                            quoteStart = -1;
                        }
