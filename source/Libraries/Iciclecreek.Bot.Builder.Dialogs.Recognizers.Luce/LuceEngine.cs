...
using Iciclecreek.Bot.Builder.Dialogs.Recognizers.Luce.PatternMatchers;
using Iciclecreek.Bot.Builder.Dialogs.Recognizers.Luce.PatternMatchers.Matchers;
...
namespace Iciclecreek.Bot.Builder.Dialogs.Recognizers.Luce
{
    ...
    public class LuceEngine
    {
        ...
        public IEnumerable<LuceEntity> MatchEntities(string text, IEnumerable<LuceEntity> externalEntities = null, bool includeInternal = false)
        {
        ...
        private List<LuceEntity> GetExternalEntities(string text, string locale)
        {
            ...
            return entities
                .Where(e => e.Type != "text")
                .Select(e => JObject.FromObject(e).ToObject<LuceEntity>())
                .ToList();
        }
    }
}
